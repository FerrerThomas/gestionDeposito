...
export class ProductService {
  ...
  static async updateProduct(codigo, updateData) {
    try {
      ...
      const result = await db.collection("products").updateOne({ codigo }, { $set: updateData })
      ...
      if (updateData.quantity !== undefined && updateData.quantity !== currentProduct.quantity) {
        await this.recordStockMovement({
          product_id: currentProduct._id,
          movement_type: "ajuste",
          quantity: updateData.quantity - currentProduct.quantity,
