...
// POST - Actualizar stock de productos desde archivo CSV subido
export async function POST(request) {
  try {
    ...
    console.log("Procesando archivo de stock desde datos subidos...")
    ...
    console.error("Error in POST /api/products/update-stock-file:", error)
    return NextResponse.json({ error: error.message || "Error actualizando stock desde archivo CSV" }, { status: 500 })
  }
}
